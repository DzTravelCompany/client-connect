            ...
            Expanded(
              child: Container(
                ...
                child: Column(
                  children: [
                    // Header with actions
                    _buildClientListHeader(theme),
                    const SizedBox(height: 16),

                    // Bulk actions bar
                    if (_selectedClientIds.isNotEmpty)
                      _buildBulkActionsBar(theme),

                    // Client cards list
                    Expanded(
                      child: PaginatedListView<ClientModel>(
                        ...
                        itemBuilder: (client, index) => EnhancedClientCard(
                          client: client,
        ...
        Row(
          children: [
            ...
            ComboBox<String>(
              value: _sortBy,
              items: const [
                ComboBoxItem(value: 'name', child: Text('Sort by Name')),
                ComboBoxItem(value: 'company', child: Text('Sort by Company')),
                ComboBoxItem(value: 'created', child: Text('Sort by Date Added')),
                ComboBoxItem(value: 'updated', child: Text('Sort by Last Updated')),
              ],
              onChanged: (value) {
                if (value != null) {
                  setState(() {
            ...
            onPressed: () async {
              ...
              displayInfoBar(
                ...
                builder: (context, close) => InfoBar(
                  ...
                  content: const Text('Bulk delete feature will be implemented soon.'),
                  severity: InfoBarSeverity.info,
                  onClose: close,
                ),
              );
